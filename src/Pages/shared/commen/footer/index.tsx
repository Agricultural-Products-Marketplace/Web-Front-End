...
function Footer() {
    ...
    return pathname === '/admin' || pathname === '/signup/customer' || pathname === '/signIn' || pathname === '/message' || pathname === '/signUp/' || pathname === '/signUp' || pathname === '/account'|| pathname === '/success' ? null :<section className="footer_section">
