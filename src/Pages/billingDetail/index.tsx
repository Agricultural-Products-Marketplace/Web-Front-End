    ...
    return(
        ...
        <div className="Billing-detail">
            ...
            <form className="billing-detail-main">
                <div className="billing-detail-main-left">
                ...
                <div className="billing-detail-main-right">
                    <div className="billing-detail-main-right-products">
                    ...
                    <div className="checkout-payment-bank">
                        <div className="payment-radio payment-radio-first">
                            ...
                            />
                            <p>Bank</p></div>
                            <div className="checkout-payment-bank-options">
