...
function Products() {
    ...
    const originalProductData = [
        ...
        { id: 10, image:'https://www.the-sustainable-fashion-collective.com/img/http/assets.the-sustainable-fashion-collective.com/assets/the-swatch-book/2014/11/cotton.png/7c098280951a28c0f2aa4291f179ae42.png',name: 'cotton', category:'Fiber crop',qty: 'X3', date: 'Feb 6, 2020', price: '350.25', discount: '80.30', status: 'in Stock' },// Add more data as needed
    ];
    ...
    const currentProducts = (selectedOption === "All Category" ? originalProductData : originalProductData.filter(product => product.category === selectedOption)).slice(indexOfFirstProduct, indexOfLastProduct);

    const nextPage = () => {
        if (indexOfLastProduct < (selectedOption === "All Category" ? originalProductData : originalProductData.filter(product => product.category === selectedOption)).length) {
